    ...
    <div class="row">
        ...
        @include('inc.messages')
            <div class="panel panel-default">
                <div class="panel-heading h2 text-center text-uppercase">Add UNIT</div>
            ...
            <!-- school name submit(schoo_id)-->
              ...
              <!-- department name submit(department_id)-->
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="unit_id" type="text" class="form-control{{ $errors->has('unit_id') ? ' is-invalid' : '' }}" name="unit_id" value="{{ old('unit_id') }}">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="unit_name" type="text" class="form-control{{ $errors->has('unit_name') ? ' is-invalid' : '' }}" name="unit_name" value="{{ old('unit_name') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                  <span class="glyphicon glyphicon-plus"></span>  {{ __('ADD UNIT') }}
                                </button>
                            </div>
                        </div>
                    </form>
