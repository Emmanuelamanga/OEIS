    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading h2 text-center text-uppercase">EDIT COURSE</div>
            ...
            <!-- school name submit(schoo_id)-->
              ...
              <!-- department name submit(department_id)-->
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="course_id" type="text" class="form-control{{ $errors->has('course_id') ? ' is-invalid' : '' }}" name="course_id" value="{{ old('$course->course_id',$course->course_id) }}">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="course_name" type="text" class="form-control{{ $errors->has('course_name') ? ' is-invalid' : '' }}" name="course_name" value="{{ old('$course->course_name',$course->course_name) }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                  <span class="glyphicon glyphicon-plus"></span>  {{ __('UPDATE COURSE') }}
                                </button>
                            </div>
                        </div>
                    </form>
